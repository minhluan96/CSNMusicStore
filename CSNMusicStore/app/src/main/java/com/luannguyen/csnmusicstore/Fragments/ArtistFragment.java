...
public class ArtistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.artist_searchfragment_layout, container, false);

        txtError = (TextView) rootView.findViewById(R.id.txtErrorArtist);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerView_artist_search);
    ...
    public class GetListofSong extends AsyncTask<String, Void, List<Song>> {
        ...
        protected List<Song> doInBackground(String... params) {
            ...
            try {
                ...
                /*
                * for (int i = 0; i < Math.Min(10, tr.size());  i++) {
                *   // lấy thông tin trừ task lấy hình
                * }
                *
                * */
